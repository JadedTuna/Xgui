...
namespace Xgui
{
        ...
        , _lineHeight(0)
    {
        ...
        _xftfont = XftFontOpenName(Xgui::display, DefaultScreen(Xgui::display), _fontname.c_str());
    ...
    Rect Font::textExtents(String text)
    {
        ...
        XftTextExtentsUtf8(Xgui::display, _xftfont, reinterpret_cast<XftChar8 *>(_text), text.size(), &extents);
