...
namespace Xgui
{
    ...
    public:
        ...
        Button(Widget *parent, const String &label, int x, int y, size_t w, size_t h, Flags flags = Flags::NoFlags);
        Button(Widget *parent, const String &label, const Point &pos, const Size &size, Flags flags = Flags::NoFlags);
        Button(Widget *parent, const String &label, const Rect &rect, Flags flags = Flags::NoFlags);
